...
cascade_src = 'cascade.xml'  # This should be the model.xml file obtained from the cascade trainger and use the correct name here

cap = cv2.VideoCapture(0) # if try on live use 0 instead
