...
# run this program to fetch images from ur webcam
# if u dont want to use images from the webcam then just open the Cascade Trainer GUI
# https://amin-ahmadi.com/cascade-trainer-gui/
# upload many positive and negative images and then download the model
# positive ==> images including the object
# negative ==> images NOT including the object but that could be SIMILAR
# e.g.: the strawberry plant itself, not ripe strawberries , the pot ..
